...
final localizedLabels = <Locale, AppLocalizationsData>{
  const Locale.fromSubtags(languageCode: 'id'): const AppLocalizationsData(
    ...
    home: 'Home',
    seeAll: 'Lihat semua',
    state: AppLocalizationsDataState(
      loading: 'Proses',
      success: 'Sukses',
      failure: 'Gagal',
    ),
    form: AppLocalizationsDataForm(
      password: 'Password',
      username: 'Username',
      required: AppLocalizationsDataFormRequired(
